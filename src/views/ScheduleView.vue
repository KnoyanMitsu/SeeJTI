...
<template>
  <Navbar />
  <nav class="flex bg-[#0E1F43] item-center justify-between flex-warp p mb-24">
    This is Navbar
  </nav>
  <div class="container mx-auto">
    ...
    <div
      ...
      class=""
    >
      <h1 class="text-xl font-bolt">{{ hari }}</h1>
      <div class="grid gap-5 lg:grid-cols-3 mx-20 md:grid-cols-2">
        <AllSchWidget
